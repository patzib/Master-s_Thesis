...
def query_with_memory(chain, question: str, vector_db):
    ...
    try:
        ...
        # Step 2: Dynamically configure the retriever for this specific query.
        # By default, it uses the standard retrieval settings.
        retriever = vector_db.as_retriever(
            search_kwargs={"k": app_config.INITIAL_RETRIEVAL_K}
        )

        # If a lecture number was found, create a new retriever with the metadata filter applied.
        if lecture_filter > 0:
