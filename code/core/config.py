...
# For the Multilingual System Prompt: “CRITICALLY, you MUST answer in the same language as the user's question. 
# If the user asks in German, respond in German. If the user asks in English, respond in English.
# For the English only System Prompt: CRITICALLY, you MUST answer ONLY in English, regardless of the language of 
# the user's question.
